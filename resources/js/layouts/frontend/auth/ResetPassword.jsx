...
import { Lock, Mail, Loader, CheckCircle, XCircle } from 'lucide-react';
import { Link, useLocation, useNavigate } from 'react-router-dom'; // For navigation and URL params
...
const ResetPassword = () => {
    ...
    useEffect(() => {
        ...
        // Optionally, you can validate token/email on component mount if needed
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                readOnly={!!queryParams.get('email')} // Make read-only if email is from URL
                            />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 rounded-lg border focus:outline-none focus:ring-2
                                            ${errors.password_confirmation ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'}
                                            bg-gray-50 text-gray-900 placeholder-gray-500 transition-all duration-200
                                            dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:placeholder-gray-400 dark:focus:ring-blue-400`}
