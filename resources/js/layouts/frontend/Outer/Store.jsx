...
const Store = () => {
    ...
    const cardVariants = {
        ...
        hover: {
            scale: 1.03,
            boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.2)", // Softer shadow for light mode
    ...
    const buttonVariants = {
        hover: {
            scale: 1.05,
            boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.2)" // Softer shadow for light mode
        },
        tap: { scale: 0.95 }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 pt-28 px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-8
                    dark:bg-gray-950 dark:text-gray-200">
            {/* Mobile Filter Button */}
            <button
                className="lg:hidden fixed bottom-6 right-6 z-40
                           bg-gradient-to-r from-blue-500 to-purple-600 text-white
                           dark:from-blue-600 dark:to-indigo-700 p-4 rounded-full shadow-lg flex items-center justify-center space-x-2 transition-all hover:scale-105"
            ...
            <AnimatePresence>
                {(isSidebarOpen || window.innerWidth >= 1024) && ( // Show on desktop, or if mobile sidebar is open
                    ...
                    >
                        ...
                        {/* Price Range */}
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold mb-4 text-blue-600 dark:text-cyan-400">Price Range</h3>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">Filter up to ₦{priceRange[1]}.</p>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
                        ...
                        products.map((product, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.button
                                        className="mt-auto w-full py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 opacity-90 hover:opacity-100 transition-all duration-300
