                                            ...
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <p style="margin: 0; color: #2c3e50; font-size: 18px; font-weight: 700;">
                                                        {{ $order->location ? $order->location->name : 'N/A' }}
                                                    </p>
                                        ...
                                        <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                            <tr>
                                                ...
                                                <td style="padding: 8px 0; color: #2c3e50; font-size: 15px; font-weight: 600; text-align: right;">
                                                    {{ $order->full_name ?? 'Walk-in Customer' }}
                                                </td>
                                            </tr>
                                            @if($order->email)
                                            <tr>
                        ...
                        <td style="padding: 0 30px 30px 30px;">
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background: linear-gradient(135deg, #ffeaa7 0%, #fdcb6e 100%); border-radius: 8px; padding: 20px; box-shadow: 0 3px 10px rgba(253, 203, 110, 0.3);">
                                <tr>
                                    ...
                                    <td style="padding: 8px 15px; text-align: right; color: #2d3436; font-size: 15px; font-weight: 600;">₦{{ number_format($order->subtotal, 2) }}</td>
                                </tr>
                                @if($order->discount_amount > 0)
                                <tr>
                                    <td style="padding: 8px 15px; color: #d63031; font-size: 15px; font-weight: 600;">Discount Applied</td>
                                    <td style="padding: 8px 15px; text-align: right; color: #d63031; font-size: 15px; font-weight: 700;">- ₦{{ number_format($order->discount_amount, 2) }}</td>
                                </tr>
                                @endif
                                <tr>
                                    ...
                                    <td style="padding: 15px 15px 8px 15px; border-top: 2px solid #dfe6e9; text-align: right; color: #00b894; font-size: 24px; font-weight: 700;">₦{{ number_format($order->grand_total, 2) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td style="padding: 0 30px 30px 30px;">
                            <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px; border-radius: 8px;">
                                <p style="margin: 0; color: #1565c0; font-size: 14px;">
                                    <strong>⏰ Sale Completed:</strong> {{ $order->created_at->format('F j, Y g:i A') }}
                                </p>
                            </div>
                        </td>
                    </tr>
