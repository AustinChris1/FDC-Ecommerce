import{r as h,j as e,m as o,L as t,a0 as r,t as y}from"./main-j8asjrF6.js";import{F as u,T as p}from"./facebook-BxqFtT1u.js";import{f as b,a as v}from"./FdcLogoBlack-zHzX5pB1.js";import{C as k}from"./copyright-DlRMGtni.js";const f="/build/assets/instagram-B714XD8Y.svg",j="/build/assets/phone-DZiX-Iuo.svg",w="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126091.50068803449!2d7.481260032478743!3d9.030942164225989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0b964ec887e5%3A0x12a34843356767e8!2sNimota%20Plaza!5e0!3m2!1sen!2sng!4v1726406738672!5m2!1sen!2sng",N=({src:a})=>e.jsx("div",{className:"w-full pb-6 h-64 sm:h-80 rounded-xl overflow-hidden shadow-md dark:shadow-xl",children:e.jsx("iframe",{src:a,width:"100%",height:"100%",style:{border:0},allowFullScreen:"",loading:"lazy",referrerPolicy:"no-referrer-when-downgrade",title:"First Digit Communications Location"})}),T=()=>{const[a,l]=h.useState(()=>{const i=localStorage.getItem("theme");return i==="light"?!1:i==="dark"?!0:window.matchMedia("(prefers-color-scheme: dark)").matches});h.useEffect(()=>{const i=()=>{const n=localStorage.getItem("theme");l(n==="dark")};window.addEventListener("storage",i);const c=new MutationObserver(n=>{n.forEach(g=>{if(g.attributeName==="class"){const d=document.documentElement.classList.contains("dark");d!==a&&l(d)}})});return c.observe(document.documentElement,{attributes:!0}),()=>{window.removeEventListener("storage",i),c.disconnect()}},[a]);const m=new Date().getFullYear(),s={hidden:{opacity:0,y:20},visible:{opacity:1,y:0}},x={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.08,delayChildren:.1}}};return e.jsxs(o.footer,{className:`w-full p-6 text-gray-700
                       ...
                       dark:text-gray-200 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950`,variants:x,initial:"hidden",animate:"visible",children:[e.jsxs("div",{className:"absolute inset-0 pointer-events-none z-0 opacity-50 dark:opacity-30",children:[e.jsx("div",{className:"absolute top-[20%] left-[10%] w-64 h-64 bg-blue-300/30 rounded-full blur-3xl dark:bg-cyan-500/10"}),e.jsx("div",{className:"absolute bottom-[15%] right-[15%] w-72 h-72 bg-fuchsia-300/30 rounded-full blur-3xl dark:bg-purple-500/10"})]}),e.jsxs("div",{className:"container mx-auto px-4 relative z-10",children:[e.jsxs("div",{className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12
                                ...
                                dark:border-gray-700`,children:[" ",e.jsxs(o.div,{variants:s,children:[e.jsx(t,{to:"/",className:"inline-block mb-4",children:e.jsx("img",{src:a?b:v,alt:"First Digit Communications",className:`${a?"h-10 w-auto":"h-12 w-auto"}`})}),e.jsxs("p",{className:`text-sm leading-relaxed mb-4
                                      ...
                                      dark:text-gray-200`,children:[" ","Your ultimate destination for cutting-edge electronics and smart innovations. Experience the future, today."]}),e.jsxs("div",{className:"flex space-x-4",children:[e.jsxs("a",{href:"https://facebook.com",target:"_blank",rel:"noopener noreferrer","aria-label":"Facebook",className:`w-8 h-8 flex items-center justify-center rounded-full transition-all p-1
                                           ...
                                           dark:bg-gray-700 dark:hover:bg-green-600 dark:text-white`,children:[" ",e.jsx("img",{src:j,alt:"Phone",className:"w-5 h-5"})]})]})]}),e.jsxs(o.div,{variants:s,children:[e.jsx("h3",{className:`text-xl font-bold mb-6
                                       ...
                                       dark:text-white`,children:"Quick Links"}),e.jsxs("ul",{className:"space-y-3",children:[e.jsx("li",{children:e.jsxs(t,{to:"/shop",className:`text-base flex items-center group transition-colors
                                           ...
                                           dark:hover:text-cyan-400`,children:[" ",e.jsx(r,{className:`w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity
                                                       text-blue-400 /* Light mode arrow color */
                                                       dark:text-cyan-400`})," Contact"]})})]})]}),e.jsxs(o.div,{variants:s,children:[e.jsx("h3",{className:`text-xl font-bold mb-6
                                       text-gray-900 /* Light mode header text: dark gray */
                                       dark:text-white`,children:"Support"}),e.jsxs("ul",{className:"space-y-3",children:[e.jsx("li",{children:e.jsxs(t,{to:"/support/faq",className:`text-base flex items-center group transition-colors
                                           ...
                                           dark:hover:text-cyan-400`,children:[" ",e.jsx(r,{className:`w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity
                                                       text-blue-400 /* Light mode arrow color */
                                                       dark:text-cyan-400`})," Terms of Service"]})})]})]}),e.jsxs(o.div,{variants:s,children:[e.jsx("h3",{className:`text-xl font-bold mb-6
                                       text-gray-900 /* Light mode header text: dark gray */
                                      ...
                                      dark:text-gray-300`,children:[" ",e.jsx(y,{className:`w-5 h-5 mr-3 mt-1 flex-shrink-0
                                               ...
                                               dark:text-gray-400`})," ","Suite 011, Nimota Plaza, Plot 855, Tafawa Balewa Way, Area 11, Garki Abuja, Nigeria"]}),e.jsx(N,{src:w})]})]}),e.jsxs(o.div,{variants:s,className:`pt-8 text-center text-sm
