...
return [
    'bots' => [
        'spxFDC_bot' => [ // You can name your bot anything, e.g., 'default'
            'token' => env('TELEGRAM_BOT_TOKEN'),
            'username' => 'spxFDC_bot', // Optional, but good practice
            'commands' => [
                // Your bot commands if any
            ],
        ],
    ],

    'default_bot' => 'spxFDC_bot', // Set this to your chosen bot name
    /*
    |--------------------------------------------------------------------------
